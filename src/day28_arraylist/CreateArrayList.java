...
public class CreateArrayList {
    public static void main(String[] args) {
       // ArrayList <String> listOne = new ArrayList<>(Arrays.asList("hello", "bye"));
        ...
        ArrayList <String> listTwo =  new ArrayList<>(listOne);//Adds the elements from the listOne ArrayList
        //into the listTwo ArrayList
        listTwo.add("Salam");
        System.out.println("-----------");
        System.out.println(listOne);
        ...
        //How can I get the last element dynamically from lastThree?
        System.out.println(listThree.get( listThree.size() - 1));

        //Get the last element and make all in UPPERCASE and re-assign back to that index
        String newUpp = listThree.get(listThree.size()-1).toUpperCase();
        listThree.set(listThree.size()-1, newUpp);
//        System.out.println(listThree.set(listThree.size()-1, listThree.get(listThree.size()-1).toUpperCase()));
        System.out.println(listThree);
    }
}
