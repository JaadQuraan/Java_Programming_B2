 ...
 */
    public static void main(String[] args) {
        ...
        System.out.println(nums.indexOf(100)); //first match elements index

        System.out.println(nums.indexOf(700)); // -1
       int ind = nums.indexOf(200); //1
        System.out.println(ind);

        System.out.println(nums.lastIndexOf(100)); //5
        System.out.println(nums.lastIndexOf(50000)); // -1

        System.out.println(nums.get(nums.size()-1)); // Gets value of last index.  100
