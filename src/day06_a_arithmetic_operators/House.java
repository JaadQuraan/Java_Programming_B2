...
public class House {
    public static void main(String [] args){
        ...
        double price = 9_999_999.99; //9,999,999.99 java will avoid underscore in the numbers to make it more readable
        //double will have decimal point as .0 if no decimal in the number
