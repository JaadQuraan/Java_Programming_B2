...
//        ShoppingList.showListItems(drinks);
        ...
        String [] allDrinks = {"cola", "monster", "red bull", "sarkiz"};
        //ArrayList <String> drinks4 = new ArrayList<>(allDrinks); This is not ok
        //Why because array is not valid argument. ArrayList only accepts collection data structure
        ArrayList <String> drinks3 = new ArrayList<>(Arrays.asList(allDrinks));//Here is ok we converted array into
        //ArrayList
        System.out.println(drinks3);
        ArrayList <String> drinks5 = new ArrayList<>(Arrays.asList("Water", "Doyga", "Ayran"));
        System.out.println(drinks5);

        drinks.addAll(Arrays.asList("Water", "Su", "Voda")); //added to the end as a collection
        System.out.println(drinks);
        ...
        System.out.println(drinks); //Starts from Fanta
