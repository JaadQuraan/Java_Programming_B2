...
/*
    ...
    .addAll(Collection) -> Collection  ->Arrays.asList(arg) -> All will be added to end of the list
    .addAll(index, Collection) -> Collection  ->Arrays.asList(arg) -> All will be added starting from the given INDEX
    .removeAll (Collection) -> Collection  ->Arrays.asList(arg) -> All will be removed starting from the given INDEX
    .retainAll (Collection) -> Collection  ->Arrays.asList(arg) -> All the matching ones will be KEPT and the rest will be removed
    .containsAll (Collection) -> Collection ->Arrays.asList(arg) ->If ALL the collection are in the ArrayList return true, if not return false
 */
...
public class JobTitles {
    public static void main(String[] args) {
        ...
        allJobs.addAll(Arrays.asList
        ("SDET", "DEV", "PO", "CEO", "DEVOP", "QA", "QE", "BA", "SM", "PM", "SH", "Team Lead", "Client","Domain Expert", "SME"));
        //DEVOP - pushes code from one env to another.People who set up env
        ...
        System.out.println(jobs3.containsAll(Arrays.asList("SDET", "PM", "SME"))); //T /F
        System.out.println(jobs3.containsAll(Arrays.asList("Doctor", "PM", "SME"))); // T/F
