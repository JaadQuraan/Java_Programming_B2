...
public class RemoveCountries {
    ...
    public static ArrayList<String> removeCountries (ArrayList<String>  countries){
        ArrayList <String> updatedCountries = new ArrayList<>(countries);
        updatedCountries.removeIf(eachCountry -> eachCountry.length() < 7);
    ...
    public static void main(String[] args) {
        ...
        ArrayList <String> countries = new ArrayList<>
                (Arrays.asList("Japan", "Korea", "United States", "Turkey", "United Kingdom", "Canada"));
